  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <AdminCard><p className="text-sm text-zinc-400">Status</p><p className="mt-2 text-lg font-black uppercase text-cyan-100">{testimonials.length ? "Testimonials live" : "Ready for first testimonial"}</p></AdminCard>
      </div>
      <AdminCard>
